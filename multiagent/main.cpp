...
#include "algorithms/circus.h"
// end algorithm includes

// begin platform includes
#include "platforms/multirotor.h"
...
int main(int argc, char **argv)
{
  ...
  // add circus factory
  aliases.clear();
  aliases.push_back("circus");
  controller.add_algorithm_factory(aliases,
                                   new algorithms::circusFactory());

  // end adding custom algorithm factories

  // begin adding custom platform factories
  controller.add_platform_factory({"multirotor"},
                                  new platforms::multirotorFactory());
